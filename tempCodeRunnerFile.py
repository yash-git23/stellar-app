      ...
      <div className="relative z-10 px-6 py-12">
        ...
        <div className="text-center mt-24 pb-12">
          ...
          <div className="flex items-center justify-center gap-4 text-gray-500 text-xs">
            <a href="https://api.nasa.gov" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
              NASA API
            </a>
            <span>•</span>
            <a href="https://genelab.nasa.gov" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
              GeneLab
            </a>
            <span>•</span>
            <a href="https://osdr.nasa.gov" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
              OSDR
            </a>
          </div>
        </div>
